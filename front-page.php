	...
	<main id="primary" class="site-main">
		...
		<section class="w-full">
			...
			while ( have_rows( 'slides' ) ) :
				...
				?>
				<li class="min-h-[565px] flex flex-col place-content-end p-12" style="background-color:#efefef; background-image: url(<?php echo $image['url']; ?>);">
		...
		<section>
			<?php 
			while ( have_rows( 'gallery_section' ) ) :
				the_row(); 
...
endwhile; 
		...
		<?php endif; ?>
			...
			<?php if ( have_rows( 'shutter_colour' ) ) : ?>
				<?php 
				while ( have_rows( 'shutter_colour' ) ) :
					the_row(); 
					$section_heading = get_sub_field( 'title' );
					$description     = get_sub_field( 'description' );
					...
					<section class="">
						<div class="max-w-[1320px] m-auto flex flex-col pt-10 px-10 items-center">
							...
							if ( have_rows( 'shutter_colours_items' ) ) :
								while ( have_rows( 'shutter_colours_items' ) ) :
									the_row();
					...
					while ( have_rows( 'inspiration' ) ) :
						...
						<div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
							...
							if ( have_rows( 'shutter_images' ) ) :
								while ( have_rows( 'shutter_images' ) ) :
									the_row();
			...
			<!-- LOCATION SECTION -->
			<?php 
			if ( get_field( 'display_section_on_page' ) ) :
						...
						<section>
						  ...
						  <?php if ( have_rows( 'location_posts' ) ) : ?>
						   <div class="flex flex-col sm:grid sm:grid-cols-2 md:grid-cols-3 gap-3">
								...
								<?php 
								$location = get_field( 'location' )['location_posts'];
